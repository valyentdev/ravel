...
func getNetlinkAddr(ipConfig initd.IPConfig) (*netlink.Addr, error) {
...
func applyIPConfig(link netlink.Link, ipConfig initd.IPConfig) error {
...
func networkSetup(config initd.NetworkConfig) error {
...
func writeEtcResolv(entries initd.EtcResolv) error {
...
func writeEtcHost(hosts []initd.EtcHost) error {
