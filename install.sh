...
latest() {
    curl -s https://api.github.com/repos/alexisbouchez/ravel/releases/latest | grep "tag_name" | cut -d '"' -f 4
}
...
installLatest() {
    ...
    download_url="https://github.com/alexisbouchez/ravel/releases/download/$version/ravel_${version_without_v}_linux_amd64.tar.gz"
