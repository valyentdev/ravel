...
To run in a cluster configuration, you need to give an access to a [NATS server](https://docs.nats.io/running-a-nats-service/introduction) both to the Agent and the Server.
