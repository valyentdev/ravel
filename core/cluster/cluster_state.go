...
type Queries interface {
	...
	UpdateMachineMetadata(ctx context.Context, machineID string, metadata api.Metadata) error
	UpdateFleetMetadata(ctx context.Context, fleetID string, metadata api.Metadata) error
