...
func getNetlinkAddr(ipConfig IPConfig) (*netlink.Addr, error) {
...
func ApplyIPConfig(link netlink.Link, ipConfig IPConfig) error {
...
func NetworkSetup(config NetworkConfig) error {
